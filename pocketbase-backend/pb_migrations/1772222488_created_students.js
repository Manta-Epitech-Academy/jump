...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_2651147324",
    "indexes": [
      "CREATE UNIQUE INDEX `idx_7fhSHFWyyo` ON `students` (\n  `campus`,\n  `nom`,\n  `prenom`,\n  `email`\n)",
      "CREATE UNIQUE INDEX `idx_tokenKey_plgztnbjn2` ON `students` (`tokenKey`)",
      "CREATE UNIQUE INDEX `idx_email_plgztnbjn2` ON `students` (`email`) WHERE `email` != ''"
    ],
