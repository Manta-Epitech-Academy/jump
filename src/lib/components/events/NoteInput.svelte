	...
	<div class="relative w-full">
		<Input
			...
			class={cn(
				...
				// Normal states
				status === 'error' && 'border-destructive bg-destructive/10 ring-1 ring-destructive',
		...
		>
			...
			{:else if status === 'saved'}
				<Check class="h-3.5 w-3.5 scale-100 text-green-600 transition-transform duration-300" />
