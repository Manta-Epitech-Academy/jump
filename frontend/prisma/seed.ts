  ...
  for (const s of STUDENTS) {
    ...
    const talent = await prisma.talent.create({
      data: {
        ...
        highSchoolValidatedAt: s.skipOnboarding ? new Date() : null,
        highSchoolName: s.skipOnboarding ? 'Lycée général Victor Hugo' : null,
        highSchoolCity: s.skipOnboarding ? 'Paris' : null,
