...
const rawData = [
  // --- DÉBUTANT ---
  {
    ...
    description: "Nouveau sujet 2025-26. Initiation à la programmation Python (variables, if, while).",
  ...
  },
  {
    ...
    description: "Nouveau sujet 2025-26. Création d'un jeu 'idle' en HTML/CSS/JS.",
  ...
  {
    nom: "Don't Panic",
    description: "Nouveau sujet 2025-26. Résolution de puzzle algorithmique avec Python.",
  ...
  },
  {
    ...
    description: "Nouveau sujet 2024-25. Hacker le jeu Chrome Dino via la console (Web et Hardware).",
  ...
  try {
    ...
    for (const item of rawData) {
      try {
        ...
        console.error(`❌ Erreur lors de la création/mise à jour du sujet "${item.nom}":`, err);
      }
    }
