...
const PLACEHOLDER_CONTENT: Record<DocumentType, string> = {
  charter:
    "Le contenu de la charte informatique et éthique sera bientôt disponible.",
  rules: 'Le contenu du règlement intérieur sera bientôt disponible.',
  'image-rights':
    "Le contenu de l'autorisation de droit à l'image sera bientôt disponible.",
};
  ...
  const htmlContent = await ejs.render(
    onboardingTemplate,
    {
      data: {
        ...
        documentContent: PLACEHOLDER_CONTENT[data.type],
