...
<div class="space-y-6">
				...
				{#each data.themes as theme}
					<Table.Row>
						<Table.Cell class="text-center"
							><Tags class="mx-auto h-4 w-4 text-muted-foreground" /></Table.Cell
						>
	...
	<Dialog.Root bind:open>
		<Dialog.Content class="sm:max-w-md">
			<Dialog.Header>
				<Dialog.Title>{isEditing ? 'Modifier' : 'Nouveau'} Thème Officiel</Dialog.Title>
			</Dialog.Header>
			<form
				method="POST"
			...
			>
				...
				<div class="space-y-2">
					...
					<Input name="nom" bind:value={$form.nom} placeholder="Ex: Python, Cybersécurité..." />
