...
<div class="mb-6 text-center">
  ...
  >
    Charte Informatique et &Eacute;thique
  </h1>
  <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
    Prends connaissance de la charte avant de continuer.
  </p>
</div>
...
>
  ...
  >
    Le contenu de la charte informatique et &eacute;thique sera
    bient&ocirc;t disponible.
  </p>
</div>

<!-- Accept form -->
<form method="POST" action="?/signCharter" use:enhance class="mt-6">
  <label
  ...
  >
    ...
    <span class="text-sm text-slate-700 dark:text-slate-300">
      J'ai lu et j'accepte la charte informatique et &eacute;thique
    </span>
  </label>
