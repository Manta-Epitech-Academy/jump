<script lang="ts">
	...
	import { Trophy, Rocket, Link as LinkIcon, Calendar, Image as ImageIcon } from 'lucide-svelte';
...
<div class="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
	...
	<div class="relative z-10 mx-auto max-w-3xl px-4 py-8 sm:py-12">
		...
		>
			...
			<h1 class="relative z-10 mb-2 font-heading text-4xl tracking-tight uppercase sm:text-5xl">
		...
		<!-- Portfolio Section -->
		<div class="mt-10">
			<h2 class="mb-6 flex items-center gap-2 font-heading text-2xl tracking-wide uppercase">
			...
			{#if items.length === 0}
				...
				>
					<p class="font-medium text-slate-500">Ce profil est encore en construction.</p>
				</div>
			{:else}
