          ...
          {:else}
            <div class="space-y-6">
              ...
              <div class="rounded-sm border">
                ...
                >
                  <span
                    >Revue des élèves ({analysisResult.analysisData
                      .length})</span
                  >
                  <span class="text-muted-foreground"
                    >Cochez ceux qui apportent leur PC</span
                  >
                </div>
                    ...
                    {#each analysisResult.analysisData as row (row.id)}
                      ...
                      >
                        ...
                        <div class="w-full lg:flex-1">
                          {#if row.existingStudent}
                            <div
                              class="rounded border bg-white p-2 text-sm shadow-sm"
                            >
                        ...
                        >
                          ...
                          <div class="mt-1 flex flex-col gap-1">
                            <button
                              ...
                              onclick={() =>
                                toggleDecision(row.id, 'CREATE_NEW')}
                            >
                              <div class="flex items-center gap-2">
                            ...
                            {#if row.existingStudent}
                              <button
                                ...
                                'LINK_EXISTING'
                                  ...
                                  : 'text-muted-foreground hover:bg-muted'}"
                                onclick={() =>
                                  toggleDecision(row.id, 'LINK_EXISTING')}
                              >
                                <div class="flex items-center gap-2">
              ...
              >
                ...
                >
                  ...
                  >
                    {isConfirming
                      ? 'Création en cours...'
                      : "Valider l'import et les décisions"}
                  </Button>
                </div>
              </form>
            </div>
    ...
    <Tabs.Content value="manual">
      <Card.Root class="mt-4">
        <Card.Header>
          ...
          <Card.Description
            >Définissez les informations générales de l'événement.</Card.Description
          >
        </Card.Header>
        <Card.Content>
          <form
                ...
                <div class="flex gap-2">
                  <Select.Root type="single" bind:value={hour}>
                    ...
                    <Select.Content class="h-50 overflow-y-auto">
                      {#each hours as h (h)}<Select.Item value={h}
                          >{h}</Select.Item
                        >{/each}
                    </Select.Content>
                  </Select.Root>
                  ...
                  <Select.Root type="single" bind:value={minute}>
                    ...
                    <Select.Content>
                      {#each minutes as m (m)}<Select.Item value={m}
                          >{m}</Select.Item
                        >{/each}
                    </Select.Content>
                  </Select.Root>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div class="space-y-2">
                ...
                <p
                  class="text-[10px] font-bold text-muted-foreground uppercase"
                >
                  Sélectionnez un thème existant ou tapez-en un nouveau pour le
                  créer.
                </p>
