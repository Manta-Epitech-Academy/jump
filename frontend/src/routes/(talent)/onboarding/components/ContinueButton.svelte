...
<Button
  ...
  class={cn(
    'h-auto w-full gap-2 rounded-2xl bg-epi-tech px-6 py-3 text-black shadow-lg shadow-epi-tech/20 transition-all duration-200 hover:bg-epi-tech hover:brightness-110 disabled:opacity-50',
    className,
  )}
>
  {#if submitting}
