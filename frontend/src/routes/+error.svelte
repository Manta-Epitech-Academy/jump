...
<div class="error-container">
	...
	<div class="content">
		...
		<div class="icon-container">
			...
			<div class="icon-circle" class:border-404={is404} class:border-error={!is404}>
				{#if is404}
		...
		<div class="terminal">
			...
			<div class="terminal-body">
				<div class="log-line">
					<span class="log-prompt" class:text-blue={is404} class:text-error={!is404}>
						&gt; error:
					</span>
					<span>
						{#if is404}
							Segmentation fault (core dumped). L'URL demandée pointe vers une zone mémoire non
							allouée.
						{:else}
							{page.error?.message || 'Exception non gérée survenue lors du traitement.'}
						{/if}
					</span>
				</div>
				{#if !is404}
