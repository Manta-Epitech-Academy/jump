...
<ParentFlowShell>
  <main
    class="relative z-10 flex flex-1 items-center justify-center overflow-y-auto p-4"
  >
      ...
      >
        ...
        >
          ...
          <strong
            ...
            orientation</strong
          > : ateliers, défis, rencontres avec une promo curieuse et motivée. Nos
        ...
        <Button
          ...
          class="h-auto w-full rounded-2xl bg-epi-tech px-6 py-3 text-black shadow-lg shadow-epi-tech/20 transition-all duration-200 hover:bg-epi-tech hover:brightness-110"
        >
          Continuer
        </Button>
      </div>
